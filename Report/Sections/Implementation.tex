...
\begin{itemize}
    ...
    to 1 and \code{LCD\_RW} to 0. Each character is represented by a 8-bit vlaue, and it must be transferred as before by sending first the upper nimble ant then the lower nimble.
